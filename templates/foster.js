"use strict";
    ...
    function formValidation() {
        ...
        if (fname != '' && lname != '' && phone != '' && email != '' && age != '' && address != '' && city != '' && postal != '' && province2 != '' && country != '') // condition for check mandatory all fields

        {
            let confirmation = "Once you submit this form, you can't go back \nAre you sure you want to leave this page?";
            if (confirm(confirmation) == true) {
                const dict_values = {fname, lname, phone, email, age, address, city, postal, province2, country} //Pass the javascript variables to a dictionary.
                ...
                fetch(urlPath)
                    .then(response => {
                        ...
                        if(response.status == 200) {
                            window.location.href = "/fosterForm2";
                        }
                    })
                    .catch(err => {
                        console.log(err);
